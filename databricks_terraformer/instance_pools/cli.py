...
def export_cli(dry_run, delete, git_ssh_url, api_client: ApiClient, hcl, pattern_matches):
    ...
    if hcl:
        ...
        with GitHandler(git_ssh_url, "instance_pools", delete_not_found=delete,dry_run=dry_run) as gh:
            for pool in pools:
                ...
                instance_pool_hcl = create_hcl_from_json(o_type, name, identifier, pool_resource_data, False)
